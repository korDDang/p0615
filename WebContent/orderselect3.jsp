...
int totalsum=0;
try{
	String sql="select p.productId,p.name,sum(o.orderQty),sum(o.unitPrice*orderQty) from order0614 o,product0614 p where o.productId=p.productId group by p.productId,p.name ";
