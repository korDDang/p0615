...
int totalsum=0;
try{
	String sql="select to_char(o.orderDate,'YYYY-MM-DD'),p.productId,p.name,sum(o.orderQty),sum(o.unitPrice*orderQty) from order0614 o,product0614 p where o.productId=p.productId group by o.orderDate,p.productId,p.name order by o.orderDate ";
